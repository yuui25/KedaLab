...
| 3.5 | Network Sniffing | [`01_Reconnaissance/SMB_Enumeration.md`](./01_Reconnaissance/SMB_Enumeration.md)（NTLM 観点）/ [`02_Initial_Access/FTP.md`](./02_Initial_Access/FTP.md)（§6 PCAP 経由の平文認証情報抽出）/ [`02_Initial_Access/Mail_Services.md`](./02_Initial_Access/Mail_Services.md)（SMTP / POP / IMAP 平文 AUTH） |
