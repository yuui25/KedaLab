...
### Step 2A：Bearer/Token中心（scope/claim が境界変数）
...
### Step 2B：Cookie中心（session/csrf が境界変数）
...
### Step 2C：GraphQL中心（field-level の境界）
...
### Step 3：境界変数の差分を作る（主体差→所有差→テナント差→操作差）
