...
### Step 1：入口の“型”を確定する（UI/API/管理/連携）
...
### Step 3C：APIが本体（UI≠APIのズレを起点にする）
- 優先度の付け方：
