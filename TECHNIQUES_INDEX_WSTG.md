...
| WSTG-ATHN-10 | Testing for Weaker Authentication in Alternative Channel | `02_Initial_Access/SSH.md` / `02_Initial_Access/FTP.md` / `02_Initial_Access/Mail_Services.md` / `02_Initial_Access/WinRM.md` / `02_Initial_Access/Web_Vulnerabilities/OAuth_Attacks.md`（ソーシャルログイン経路の信頼境界破り） |
